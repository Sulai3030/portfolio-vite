    ...
    <section id="photos" className="py-24 px-4 relative">
      ...
      <RevealOnScroll>
        <div className="max-w-3xl mx-auto px-4 columns-2 flex flex-col justify-between p-4 leading-normal">
          ...
          <h2 className="text-1xl font-bold mb-8 bg-linear-to-r from-blue-600 to-[#71D7F5] bg-clip-text text-transparent text-center">
        ...
        <div className="max-w-3xl mx-auto px-4 columns-2">
          <h2 className="text-3xl font-bold mb-8 bg-linear-to-r from-blue-600 to-[#71D7F5] bg-clip-text text-transparent text-center"></h2>
