          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)] transition">
              ...
              <p className="text-gray-400 mb-4 text-left">
                ...
                relevant resources. - Communicated the foundation’s message
                through updates on the homepage, highlighting the mission,
                upcoming events, enrollment opportunities, and scholarships.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["Drupal"].map((tech) => (
                  <span
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                ...
                <p className="text-gray-400 text-left mb-4">
                  ...
                  in a clear and concise manner. I created User Guides and
                  Manuals to aid end-users, such as architects, contractors,
                  superintendents, and the general public, in understanding and
                  using the online portal for the New York City Department of
                  Buildings’ website.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  {["Javascript", "HTML", "CSS"].map((tech, key) => (
