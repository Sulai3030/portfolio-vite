          ...
          <div className="rounded-xl p-8 border bg-[#131417] border-white/10 hover:-translate-y-1 transition-all">
            ...
            <div className="max-w-3xl mx-auto px-4 space-y-4 mt-8">
              ...
              <p className="text-1xl text-gray-300 text-left mb-6">
                I have edited and written healthcare policy for official
                websites such as this one for the State of New York touting the
                roll-out of a new health insurance plan for the disabled
                population. New York Medicaid Choice is the managed care
                enrollment program of the New York State Department of Health.
                <li>
                  <a
              ...
              <p className="text-1xl text-gray-300 text-left mb-6">
                I am also a technincal writer having written for the New York
                City Department of Bulidings when they digitized the process by
                which building owners register to build new, and/or improve upon
              ...
              <p className="text-1xl text-gray-300 text-left mb-6">
                For years I wrote Film and TV reviews. Samples can be found
                here:
                <li>
                  <a
